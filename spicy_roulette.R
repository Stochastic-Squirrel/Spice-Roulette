...
#fit lm
model <- lm(data=r_results, formula = all_spicy_chance ~ round_number)
#notice how this is a case where fits all LM assumptions, but it is just a shitty predictor

#TODO have a bayesian % chance you can spot out a correct spicy burger
#TODO have an interation variable where you will play size n games of R rounds x number of times